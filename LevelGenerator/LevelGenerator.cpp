...
void ALevelGenerator::FixInitialRoom(TSubclassOf<ALevelInfo> initialRoomInfoClass) {
  ...
  ALevelInfo* levelInfo = this->GetWorld()->SpawnActor<ALevelInfo>(initialRoomInfoClass.Get(), loc, rot);
...
bool ALevelGenerator::FixRoom(TSubclassOf<ALevelInfo> roomInfoClass) {
  ...
  FVector loc = this->GetActorLocation();
  FRotator rot = this->GetActorRotation();
  ALevelInfo* levelInfo = this->GetWorld()->SpawnActor<ALevelInfo>(roomInfoClass.Get(), loc, rot);
  check(levelInfo);
